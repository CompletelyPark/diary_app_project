...
//import com.jinwan.appproject.list.Diary_in;
...
//
//    public DiaryOutAdapter(List<Diary_out> diaryOutlist) {diary_outlist = diaryOutlist;}
//
//    @NonNull @Override
//    public DiaryOutViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_daily_diary,parent,false);
...
//        holder.imageView_article.setImageDrawable(R.drawable.article_48px);
//        holder.title_diary.setText(diary_out.getTitle());
//        holder.imageView_icon.setImageDrawable(R.drawable.cloud_48px);
//
//    }
//
//    @Override
