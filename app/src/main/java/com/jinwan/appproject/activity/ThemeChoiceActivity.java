    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_theme1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ThemeHelper.setTheme(ThemeChoiceActivity.this, R.style.Base_Theme_AppProject);
            }
        });
        ...
        btn_theme2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ThemeHelper.setTheme(ThemeChoiceActivity.this, R.style.Theme2FFC2E);
            }
        });
        btn_theme3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ThemeHelper.setTheme(ThemeChoiceActivity.this, R.style.ThemeB59DF7);
            }
        });
        btn_theme4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ThemeHelper.setTheme(ThemeChoiceActivity.this, R.style.ThemeFFDE3F);
            }
        });
    }
